...
$(window).scroll(function(){
    ...
    if( wScroll > $('.flower6').offset().top - 550 ) {
        $('.flower6').addClass('muncul');
    } else {
        $('.flower6').removeClass('muncul');
    }

    if( wScroll > $('.title6').offset().top - 600 ) {
        $('.title6').addClass('muncul'); 
    } else {
    ...
    if(wScroll > $('.btn-map1').offset().top - 550 ) {
        $('.btn-map1').addClass('muncul');
    } else {
        $('.btn-map1').removeClass('muncul');
    }

    if(wScroll > $('.btn-map2').offset().top - 550 ) {
        $('.btn-map2').addClass('muncul');
    } else {
        $('.btn-map2').removeClass('muncul');
    }
...
// countdown
const targetDate = new Date("June 20, 2026 13:00:00").getTime();
